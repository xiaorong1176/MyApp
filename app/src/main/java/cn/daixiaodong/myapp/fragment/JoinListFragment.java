...
public class JoinListFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        /*if(mView == view){
            Log.i("JoinListFragment","mView==view");
        }*/
    }
...
/*
        mView.findViewById(R.id.id_btn_query_join).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AVObject dream = new AVObject("dream");
                dream.put("title", "我不想当程序猿");
                dream.saveInBackground(new SaveCallback() {
                    @Override
                    public void done(AVException e) {
                        if (e == null) {
                            AVUser avUser = AVUser.getCurrentUser();
                            AVRelation<AVObject> relation = avUser.getRelation("join");
                            relation.add(dream);
